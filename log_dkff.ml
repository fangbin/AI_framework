...
[kernel] Parsing ../mem/bench/dkff/dkffmain.c (with preprocessing)
/Users/yuezhuang/Documents/projects/mem/bench/dkff/dksl_refine.h:2:[kernel] user error: unexpected token '*'
