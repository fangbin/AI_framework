...
[mman] new eshape value:
         ({peid:3}
       eshape: stack:stack:(seid:0,peid:3) 
...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:10, seid:0, psz:15...
[mman] MSH:evalE ...
[mman] MSH:guard_one return constraint:sv_10>=0
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:2, seid:0, psz:15...
...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:3, seid:0, psz:15...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
...
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:12, seid:0, psz:15...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
[mman] MSH:guard_one return constraint:sv_12>=0
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:13, seid:0, psz:15...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
[mman] MSH:guard_one return constraint:sv_13>=0
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:14, seid:0, psz:15...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
...
[mman] After project out caller locals: {peid:0}
       eshape: stack:stack:(seid:1,peid:0) 
        (4)_heapstart |-> (4)_heapstart,
        (7)_heapend |-> (7)_heapend,
...
[mman] MSH:mutate_meminfo, sviL:sv_6......
...
[mman] MV:finish do_assign, new eshape value:
        ({peid:3}
       eshape: stack:stack:(seid:3,peid:0) 
        (4)_heapstart |-> (4)_heapstart,
        (6)c4__fn |-> (6)c4__fn,
        (7)_heapend |-> (7)_heapend,
...
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_9......
[mman] MV:eshape mutate done, esh.seid:3
[mman] MV:shape is not changed...
[mman] MV:finish do_assign.
[mman] MV:finish do_assign, new eshape value:
        ({peid:3}
       eshape: stack:stack:(seid:3,peid:0) 
...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:4, seid:3, psz:12...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MV:after evaE:sv_6
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_10......
...
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_31......
...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:7, seid:3, psz:12...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:4, seid:3, psz:12...
[mman] MSH:evalE_svid, no need to look in stack ...
...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:10, seid:3, psz:12...
[mman] MSH:evalE ...
...
[mman] MV:after evaE:0
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_1......
[mman] MSH:mutate_meminfo, ACst......
...
[mman] MV:finish do_assign, new eshape value:
        ({peid:4}
       eshape: stack:stack:(seid:4,peid:5) 
        (4)_heapstart |-> (4)_heapstart,
        (6)c4__fn |-> (6)c4__fn,
        (7)_heapend |-> (7)_heapend,
        (9)c7__fn |-> (2)__hli,
...
[mman] After formal args assign: {peid:4}
       ...
       emp,
        ...
        dwords:{seid_4, peid_5}[|f1677_nbytes-20=0; c7__fn=0; c7__csz=0; c4__fn=0;
                         c4__csz=0; -c6__csz+8memleft+8>=0; c6__csz-8memleft+8>=0|]
[mman] MV:change_env...
[mman] MV:peid:4, old peid:5, new peid(eid common): 1
...
[mman] After project out caller locals: {peid:1}
       eshape: stack:stack:(seid:5,peid:1) 
        (4)_heapstart |-> (4)_heapstart,
        (6)c4__fn |-> (6)c4__fn,
        (7)_heapend |-> (7)_heapend,
        (9)c7__fn |-> (2)__hli,
...
[mman] MV:meet_exp_set....
[mman] MV:meet_exp_one, peid:5, esh.seid:5....
[mman] MSH:do guard, seid:5...
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:13, seid:5, psz:16...
[mman] MSH:evalE ...
[mman] MSH:guard_one return constraint:sv_13>=0
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:14, seid:5, psz:16...
[mman] MSH:evalE ...
[mman] MSH:guard_one return constraint:sv_14>=0
[mman] MSH:do guard_one...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:1, seid:5, psz:16...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:12, seid:5, psz:16...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
...
[mman] MV:after evaE:0
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_14......
[mman] MSH:mutate_stack
...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:10, seid:5, psz:16...
[mman] MV:after evaE:sv_6
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_13......
[mman] MSH:mutate_meminfo, location in stack...
[mman] MSH: svR: (6)c4__fn
[mman] MSH:mutate_stack
[mman] MV:eshape mutate done, esh.seid:5
...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:15, seid:5, psz:16...
[mman] MSH:evalE_svid, no need to look in stack ...
...
[mman] ASY:to_senv_lval, vi:nxt, svi:(13)nxt.....
[mman] MSH:evalL,AVar, lv:sv_13...
[mman] MSH:location to which sv_13 points is sv_6...
[mman] MV:after evaL:csz(sv_6)
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE ...
...
[mman] MSH:new senv: senv_8 = @(0,penv_1,
       [7] 
        senv:
       {	(30)c6__csz;	(31)c6__fn;	(32)__s32;	(33)__s33;	(34)c33__csz;
       	(35)c33__fn;	(36)__s36;} 
        penv_1:
       {	(0)__null;	(1)__hole;	(2)__hli;	(3)__hst;	(4)_heapstart;
       	(5)c4__csz;	(6)c4__fn;	(7)_heapend;	(8)c7__csz;	(9)c7__fn;
       	(10)frhd;	(11)memleft;	(12)f1677_nbytes;	(13)nxt;	(14)prev;
       	(15)nunits;} @)
[mman] New shape:stack:stack:(seid:8,peid:1) 
        (4)_heapstart |-> (4)_heapstart,
        (6)c4__fn |-> (6)c4__fn,
        (7)_heapend |-> (7)_heapend,
        (9)c7__fn |-> (2)__hli,
...
[mman] MV:eshape mutate done, esh.seid:5
[mman] DW:change_env...
[mman] DW:eid:5, eiold:5, einew: 8
[mman] DW:assertion value eid 5 = old eid 5
[mman] DW:env2apron,seid:8, env_vars list length: 23
[mman] DW:env2apron: 
        seid_8 -> [6]
       [0> __hli:int 1> __hole:int 2> __hst:int 3> __null:int 4> __s32:int 5> __s33:int 6> __s36:int 7> _heapend:int 8> _heapstart:int 9> c33__csz:int 10> c33__fn:int 11> c4__csz:int 12> c4__fn:int 13> c6__csz:int 14> c6__fn:int 15> c7__csz:int 16> c7__fn:int 17> f1677_nbytes:int 18> frhd:int 19> memleft:int 20> nunits:int 21> nxt:int 22> prev:int]
[mman] DW: emvironment changed
[mman] MV:finish do_assign.
[mman] MV:finish do_assign, new eshape value:
        ({peid:8}
       eshape: stack:stack:(seid:8,peid:1) 
        (4)_heapstart |-> (4)_heapstart,
        (6)c4__fn |-> (6)c4__fn,
        (7)_heapend |-> (7)_heapend,
        (9)c7__fn |-> (2)__hli,
       ...
       emp,
        ...
        dwords:{seid_8, peid_1}[|nunits-4=0; f1677_nbytes-20=0; c7__fn=0; c7__csz=0;
                         c4__fn=0; c4__csz=0; -c6__csz+8memleft+8>=0;
                         c6__csz-8memleft+8>=0|] 
       )
...
[mman] MV:do_assign: csz(nxt):=(nunits * 8), peid:8
[mman] MV:do_assign_one...peid:8, esh.seid:8, dw.seid:8
[mman] MSH:evalL afeat(fk, nxt)
[mman] ASY:to_senv_lval, vi:nxt, svi:(13)nxt.....
[mman] MSH:evalL,AVar, lv:sv_13...
[mman] MSH:location to which sv_13 points is sv_33...
[mman] MV:after evaL:csz(sv_33)
[mman] MSH:evalE ...
[mman] MSH:evalE ...
[mman] MSH:evalE_svid, svid:15, seid:8, psz:16...
[mman] MSH:evalE_svid, no need to look in stack ...
[mman] MSH:evalE ...
[mman] MV:after evaE:(sv_15 * 8)
[mman] MV:eshape mutate
[mman] MSH:mutate_meminfo, sviL:sv_35......
[mman] failure: Unsupported assign
[mman] MV:eshape mutate done, esh.seid:8
[mman] MV:shape is not changed...
[mman] MV:finish do_assign.
[mman] MV:finish do_assign, new eshape value:
        ({peid:8}
...
[mman] MV:singleton
[mman] MV:do_assign_one...peid:-1, esh.seid:-1, dw.seid:-1
[mman] MSH:evalE ...
[mman] DW:do_assign: eid:-1
[mman] DW:to_var, Mman_asyn.AVar(memleft)
[mman] failure: Unexpected exception.
                Please submit bug report (Ref. "Not_found").
[kernel] Current source was: /Users/yuezhuang/Documents/projects/mem copy/bench/la/lamalloc.c:164
